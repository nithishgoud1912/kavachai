    ...
    <div className={`bg-surface border border-border rounded-2xl p-5 shadow-xs space-y-3 ${className}`}>
      <div className="flex items-center justify-between pb-2 border-b border-border-subtle">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-serif font-bold text-base text-text">Real-Time Routing Decision Stream</h3>
        </div>
        <span className="text-xs font-mono text-text-3">Auto-Dispatcher Telemetry</span>
      </div>
